...
fun DependencyHandler.`google-places`(version:String = Versions.PLACES) = "com.google.android.libraries.places:places:${version}"
fun DependencyHandler.`dialog-datetime`(version:String = Versions.DATETIME) = "io.github.vanpra.compose-material-dialogs:datetime:${version}"
fun DependencyHandler.`maps-compose-utils`(version:String = Versions.MAPS_COMPOSE_UTILS) = "com.google.maps.android:maps-compose-utils:${version}"
fun DependencyHandler.`runtime-compose`(version:String = Versions.RUNTIME_COMPOSE) = "androidx.lifecycle:lifecycle-runtime-compose:${version}"
...
fun DependencyHandler.`junit-compose`(version: String=Versions.JUNIT_COMPOSE) = "androidx.compose.ui:ui-test-junit4:${version}"
fun DependencyHandler.`espresso-core`(version: String=Versions.ESPRESSO) = "androidx.test.espresso:espresso-core:${version}"
